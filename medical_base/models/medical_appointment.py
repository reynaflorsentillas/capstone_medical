...
class MedicalAppointment(models.Model):
    ...
    consultations = fields.Many2one('medical.physician.services', string='Consultation Services', help='Consultation Services', required=True, ondelete="cascade", domain="[('physician_id', '=', physician_id)]")
